...
export function validateCardCoverage(
  ...
  pushCountIssue(result, 'Stage 2', 'bullet-1 标准回答卡', answerCard.bullets.length, 3, 5, 2, 6);
  pushRangeIssue(result, 'Stage 2', 'bullet-1 标准回答卡', getBulletBodyLength(answerCard), ANSWER_RANGE);
  ...
  pushCountIssue(result, 'Stage 2', 'bullet-2 高频追问卡', followUpCard.bullets.length, 3, 5, 2, 6);
  pushRangeIssue(result, 'Stage 2', 'bullet-2 高频追问卡', getBulletBodyLength(followUpCard), FOLLOW_UP_RANGE);
  ...
  pushCountIssue(result, 'Stage 2', 'bullet-3 易错点卡', pitfallCard.bullets.length, 3, 5, 2, 6);
  pushRangeIssue(result, 'Stage 2', 'bullet-3 易错点卡', getBulletBodyLength(pitfallCard), PITFALL_RANGE);
