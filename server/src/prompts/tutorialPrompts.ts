...
const TUTORIAL_SECTION_RULES = [
  ...
  '“面试官最可能追问的 3-5 个问题”必须按 1. 2. 3. 这样的编号单独分行写出 3 到 5 个高频追问，每行只写“问题 + 一句答题方向”，单条尽量控制在 40 到 80 字，总体信息量目标约 200 到 400 字。',
  '“这道题的易错点”必须按 1. 2. 3. 这样的编号单独分行写出 3 到 5 个易错点，每行只写“易错点 + 为什么错 / 容易混到哪里”，单条尽量控制在 40 到 80 字，总体信息量目标约 200 到 400 字。',
];
